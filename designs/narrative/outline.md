...
Every day, the protagonist plays in the garden. They are chasing the world volley record because that is the thing they have given themselves to chase. The friend behind the counter knows them by name and calls it across the court each time the rally lands. There is a locked gate at the edge of the garden, and the protagonist passes it every day without quite seeing it. Partners arrive over the months, each one widening the rally and the count, and each rally is bright the way bright things are bright when something underneath is reaching. The protagonist does not know it is reaching.
