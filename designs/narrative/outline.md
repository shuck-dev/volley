...
The structural spine of the game in acts. Story prose lives in [`story.md`](story.md). World and visual canon live in [`../art/bible.md`](../art/bible.md). Per-character portraits live in [`../characters/`](../characters/). Mechanics live in the system docs and are not repeated here.
