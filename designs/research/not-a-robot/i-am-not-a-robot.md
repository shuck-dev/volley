...
The confident schedule is not supported by the state of the question. The specific mechanism that carried the last decade of capability gains is acknowledged, by the people who built it, as hitting its ceiling. The pivot to test-time compute and synthetic data might close the remaining distance. It might not. A March 2025 AAAI survey of 475 AI researchers found 76% said scaling current LLMs alone was unlikely or very unlikely to reach AGI. [\[14\]](#ref-14) The argument for a near-term arrival is weaker than the marketing suggests, and the people who know the engineering best are the ones saying so.
