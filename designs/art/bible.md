...
The protagonist's interior sits in [`../characters/protagonist.md`](../characters/protagonist.md). The structural spine sits across [`../narrative/`](../narrative/). Tech pipeline sits in [`tech-pipeline.md`](tech-pipeline.md). Audio direction lives in SH-281.
...
14. [Venues](#14-venues)
15. [Tone](#15-tone)
16. [Palette, line, treatment](#16-palette-line-treatment)
17. [Animation and rhythm](#17-animation-and-rhythm)
18. [Touchstones](#18-touchstones)
...
The bridge between the two worlds is **Reconstruction**: the long arc after the championship win, in which the player travels freely between Construction and Reality and selected things carry across. Reconstruction is not a third visual style. The two styles stay distinct. Detail in section 8.

There is one locked gate in the entire game. It sits at the back of the garden in Construction. Walking through it transitions to the cliff in Reality. The key arrives late in Reconstruction.
...
Pacing across the climb, escalation rules, and the cumulative-shape principle live in [`../narrative/02-cracks-and-break.md`](../narrative/02-cracks-and-break.md).
...
Six descriptions of what Volley looks like when the work is landing. They are not commands; Shuck is a sanctuary for craft, not a place that tells people what to make. They are what an artist holds the work up against, on any asset, any screen, either style.
...
Surfaces carry information without HUD. UI sits inside the same hand and voice as the rest of the world. A catalogue, a rack, a pinboard, a clipboard are better than a menu. Where a menu is unavoidable, it is made by the same hand as everything else.
...
**Environments** carry foreground, middle, back. Layers move independently where the camera allows. Depth rewards sustained attention.

**Typography** locks as UI lands. Working direction: one hand-drawn-feeling display face for game-world text, one quieter reading face for UI copy. Both sit inside the line-quality rule.

---

## 17. Animation and rhythm
...
**Style can bend at emotional peaks.** Line loosens, perspective warps, the ball becomes a feeling. The rules hold; the rendering flexes. *[Ping Pong: The Animation](https://en.wikipedia.org/wiki/Ping_Pong_(manga)#Anime)* and *[Slay the Princess](https://store.steampowered.com/app/1989270/Slay_the_Princess__The_Pristine_Cut/)* are the touchstones.

Each animation state reads as a different emotion, not a different sprite.

**Rhythm.** Hits, misses, rallies, streaks, reactions, UI feedback land on a felt rhythm. The game has a pulse the art and sound both serve. Visual rhythm is felt before it is noticed.
