...
When you paint a layer, you are painting a slice of the world at a specific distance. A near layer carries the kind of detail the player's eye lands on between rallies. A deep layer can carry atmosphere: a wall of warm afternoon, a wash of submerged green, the suggestion of a tree. The friend's stall sits forward; a row of distant rooftops sits back; what lies past the locked gate sits further back still.
