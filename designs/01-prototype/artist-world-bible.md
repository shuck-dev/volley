...
The bible describes the world: its tone, its visual texture, its emotional shape, its core canon. Pick the bits that resonate and let the rest be ambient context.

---

## What the player meets first

A garden in the late afternoon. In one corner, a stretch of grass walled in by stone and vines. Someone stands on the left of it with a racquet; across the way, someone leans on the counter of a small wooden stall, head tilted toward the play. Between them, a ball in the air. The counter on the wall reads zero. The light is warm.
...
- **Left side.** Where the protagonist stands. Open behind them; if the ball passes here, the rally ends.
- **Right side.** Where the partner stands. Before the first partner arrives, a wall stands in for them and returns the ball. After the partner arrives, the partner returns it. Open behind them past the partner; missing here also ends the rally.

The court visibly opens onto the rest of the venue. A missed ball does not despawn. It keeps its velocity, rolls out of the court, loses energy on the venue floor, and comes to rest wherever it stops. Resting balls render in the mid or foreground over the shop and workshop, so they stay visible.

The constant the player carries is the protagonist's racquet. Equipment items attach to it. The artist will shape it, and the shape will travel.

---

## The protagonist

The person whose game this is. Androgynous, agender, mid-30s, less athletic than they used to be, the kind of person who picked up a racquet long ago and never quite put it down. Gentle with themselves, and we should be too. Not a tragic figure, not melodramatic, not a person in collapse. Someone who built a place where they could keep playing.

In the bright world they are rarely embodied. The world is built around their quiet presence at its centre rather than their figure.

In the quieter world they are on screen. The brief asks for a real-world memory beat with them, observed fly-on-the-wall: a small moment with a partner in an ordinary place. That is where they get a body. Mid-30s, a little softer than they once were, gentle in posture. The artist's first quieter-world deliverable will set the rest of their physical specifics.

They lost someone close to them. Recently enough that it is not healed, long enough that they have built a structure around it. The bright world is that structure. They do not hide on purpose; they hide because the structure was the thing they could build that held.
...
In the quieter world they are quieter still. A photograph. A figure across a kitchen table. A back walking down a street. The bright-world version is a bigger, brighter rendering of someone the protagonist remembers very specifically.

---

## Martha

A partner. She joins the right side of the court once the player has built up enough warmth between her and the protagonist, and from then on she is the one returning the ball from her side.
...
A garden. The setting is a UK and Mediterranean blend, warm climate; the architecture reads part European cottage, part Mediterranean patio, part a memory the protagonist is reaching for that does not exactly belong anywhere. Stone or terracotta tiles underfoot. A wall or wooden fence around the edge. A tree at the back, an olive or fig or apple, branches already old. Late afternoon light, warm and slant. The garden feels lived-in. Paint chips, vines on the wall, a watering can on its side near the tree.
...
A ball feeder sits on one side of the play area, holding the balls that are not currently in play. A smaller rack opposite holds equipment items. Both have visible age and use.
...
## The trajectory of the bright world
...
Things that travel with the camera across every bright-world venue.

- **The protagonist's racquet.** Same shape, same colour, same handle, wherever the rally goes. Equipment hangs off it.
- **The opposing returner.** A wall in the smallest first venue, then a partner from the moment the first partner arrives.
- **The ball.** The same ball at the centre. Item skins change its art; the size and presence are the same.
- **The friend's stall.** Lashed differently per venue (against a fence, around a palm, against a meteor edge), but always recognisable. A small awning, one shelf, the friend somewhere behind it.
- **The friend's presence.** Felt across every venue. Sometimes more visible, sometimes more remote; always there.
- **The volley counter.** The same number, dressed for each venue. A wooden plaque in the garden, a coral-rimmed slate underwater, a hovering glyph in space. Diegetic everywhere.
- **The warm light register.** Colour temperature shifts venue by venue (afternoon yellow, submerged green, nebula pink, canopy gold). The warmth holds.
...
The visual register here can be anything that rhymes with the bright world: same DNA, different mood. Memory rather than fantasy. Less saturation, perhaps. More texture. The light is just light; the air has weather. People walk by; cars pass; a dog barks somewhere. The town has a pulse the bright world does not.

Quieter-world moments are short and named. A kitchen table at twilight. A walk down a particular street. A bench by a pond. A photograph on a fridge door. They are felt rather than narrated. The protagonist is in them; the friend is there; sometimes Martha or the tinkerer or another partner. Each moment is the protagonist remembering one thing in particular.

The artist's deliverable for the quieter world is a small moment between the protagonist and a partner in an ordinary place. The choice of moment shapes the cast that follows.

How the two worlds relate visually is open. The principle holds: the shift between them is not a style change. It is a change in how much comfort the art offers.
...
The roster will change before ship. The form will not.

**Items are physical objects with a small twist.** A whistle that plays a flat note. A roll of grip tape that leaves marks on everything. A locker mirror whose reflections do not stop. Mundane object plus one detail that hints at the effect.

**Items have lived in someone's life before the player got them.** Worn elastic, frayed velcro, ends stuck to themselves, paint chipped, edges creased. Nothing is new.

**Items belong somewhere on the court.** Some are equipment the protagonist clips, ties, or fixes onto the racquet, the way a player tapes a grip or fits a new string. Some replace the ball itself: a stitched leather one, a glass one, a meteor shard. Some take up a corner of the court as a piece of furniture: a music cabinet against a wall, a training wall, a small dock for the bot.

A handful of hero illustrations is more useful than a full roster, because the roster is going to move.

---

## The shop as an Argos catalogue
...
The prototype lives in the first garden venue and ends on the cliffhanger leap. Underwater is not playable in the prototype. The implication does the heavy lifting:

- **Fence edge.** What you glimpse past the fence is not a neighbour's roof. A streak of weirdness, palm fronds, a purple cloud bank, a distant something-massive.
- **Items have provenance.** Each item name and description references a place that does not exist in the prototype.
- **The friend's stall stocks oddities.** Items the friend brought back from elsewhere: a starfish, a meteor shard, a vial of glow.
- **Diegetic plaque flavour.** "Best volley: 47, set after the storm." Memory in place of HUD.
- **Single offstage character.** The friend mentions someone in passing; the player meets them later.
...
The world has a sound. Across all venues the constants the player anchors on are the racquet hit, the volley counter ticking, the ball's quiet whoosh.

**Bright/constructed venues** carry layered ambience tuned to each place: the garden has afternoon birds, distant traffic, occasional wind that carries something further; underwater is muffled, slow, with the warmth of bubbles and the friend's voice as if heard through water; the meteor is sparse, with the friend's voice carrying because there is nothing else; treetops layer birdcall, leaves moving in wind, golden silence between rallies.

**The break** is where ambience turns at once with light: layers drop or invert.

**The quieter world** is closer to a sound-isolation chamber. The outside thins; you start hearing more of yourself. Blood in the ears, breath, the small sounds your body makes that you only notice when nothing else is competing. The town is real, but the protagonist's interior register is the dominant track.

---

## The Six Marks

The art bible's rulebook. Every piece of art carries all six. They are descriptions of what Volley looks like when the work is landing, not commandments.
...
Characters carry simpler shapes than the painted backgrounds. This is a production-cost decision, not an aesthetic claim: minimal animation per character keeps the labour budget where it belongs while painterly backgrounds carry the world's weight.
...
- **Pixel art.** Hand-drawn illustration, not pixel.
- **Photoreal.** Hand-drawn warmth, not realism.
- **Vector polish.** Lines have life in them. No mechanical precision.
- **Painterly realism.** The hand-drawn mark stays visible.
- **Anime-stylised faces with big eyes.** The characters are people drawn warmly, not avatars.
- **Period pastiche.** No fixed real-world era reference.
- **Scary or distressing imagery.** The quieter register carries memory and weather, not menace.
...
2. **Earnest, never ironic.** Personal, never melodramatic. Characters are warm and particular. Items have flavour. Nothing is a wink.
3. **Stress is natural friction.** Tension has ebb and flow, the way a long rally does. Volley does not deal in chronic stress; the friction is the kind that makes a moment feel alive, not the kind that grinds.
4. **Trust the player.** No exposition. No signposting. Let the player notice, wonder, and eventually understand.

---

## Open questions where your sketch may pin

If a character or an object isn't pinned down, the artist's sketch might be what pins it. Don't wait; draw what feels right.

- The friend's gender, age, build. Deliberately open.
- The tinkerer's gender, age, presentation. Deliberately open (with one anchor: she is the friend's younger sister).
- Martha's age. Working range 45 to 60.
- The protagonist's physicality. Mid-30s, less athletic than they were, gentle, androgynous, agender.
- Exact colour palettes for both registers.
- Typography.
