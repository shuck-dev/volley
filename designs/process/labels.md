...
> **About the name.** Zaphod is the two-headed alien president from *The Hitchhiker's Guide to the Galaxy*. Volley's automation has many heads: a chorus of specialist reviewers, plus Dependabot, plus whatever lands next. The bot-applied labels share his name. The leading `z` also keeps these labels at the bottom of GitHub's label picker, out of the way of the human-applied ones.
