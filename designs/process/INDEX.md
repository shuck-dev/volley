...
How the team writes, files, dispatches, and runs the work.

| Doc | Purpose |
|---|---|
| [Ticket Writing](ticket-writing.md) | How issues get written so a stranger can pick them up cold. |
| [Labels](labels.md) | The label taxonomy. |
| [Missions and Projects](missions-and-projects.md) | Missions are milestones inside projects; the operating taxonomy. |
