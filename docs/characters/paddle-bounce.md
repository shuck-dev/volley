...
Implementation spec for the post-bounce direction computed when the ball strikes a paddle. Court-bound mechanics live in [`01-court-control.md`](../court/INDEX.md); ball state transitions live in [`02-ball-lifecycle.md`](../ball/INDEX.md).
