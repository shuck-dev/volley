...
@export var paddle_speed := 500.0
@export var paddle_size := 100.0
@export var paddle_size_min := 50.0
@export var ball_speed_min := 400.0
@export var ball_speed_max_range := 300.0
@export var ball_speed_increment := 15.0
