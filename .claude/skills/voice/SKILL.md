...
A subtler failure is the inhabited scene with nobody inside it. A vivid image of blurred tiles and a waiting checkbox is not "show"; it describes a thing while no one lives it. Sensory detail alone is still abstract. The fix is a person in the frame: the reader, stopped mid-task and made to prove they are not a machine, with their stakes visible. To persuade rather than inform, place the reader inside the true situation and let them reach the conclusion, then carry the argument from there. One situational "you" to establish presence, not a sustained second person that turns into instruction. The rules layer for this is `ai/STYLE.md`, "Persuade by identification"; the full craft note is `designs/ai/persuasive-reach-out.md`.
