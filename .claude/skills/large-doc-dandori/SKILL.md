...
Each reviewer follows `.claude/skills/reviewers/SKILL.md` for verdict shape. Approves are silent label-only; blocks post inline review comments anchored to `path:line`, never on the main PR thread.
