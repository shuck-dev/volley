...
Never flag an item that is already covered by `.claude/skills/dispatch/SKILL.md`, `.claude/skills/commits/SKILL.md`, `.claude/skills/reviewers/SKILL.md and .claude/skills/pr/SKILL.md`, `CLAUDE.md`, or CI hooks. Those rules exist; your value is pattern-matching against the diff.
