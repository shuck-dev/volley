...
- **Mechanical fixes** — rewrite the line in-place if the fix is obvious and risk-free (e.g. `@onready` → `@export` for a simple node ref; adding types to an obvious function).
